      ...
      img.onload = function () {
        ...
        $('#takenPicture')
          .css('background-position',
            '-' + afterScanFactor * cardData['position_x'] + 'px ' + '-' + afterScanFactor * cardData['position_y'] +
            'px');
...
function countCardDimensions(result, scaleFactor) {
  ...
  cardData['position_width'] = (Math.max(result.creditCardCoordinate[0].p0.x, result.creditCardCoordinate[0].p1.x,
    result.creditCardCoordinate[0].p2.x, result.creditCardCoordinate[0].p3.x) / scaleFactor - cardData['position_x']);
  cardData['position_height'] = (Math.max(result.creditCardCoordinate[0].p0.y, result.creditCardCoordinate[0].p1.y,
    result.creditCardCoordinate[0].p2.y, result.creditCardCoordinate[0].p3.y) / scaleFactor - cardData['position_y']);
